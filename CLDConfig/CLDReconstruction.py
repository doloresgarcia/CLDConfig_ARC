...
tracking_group.add_argument("--genTracking", action="store_true", default=False, help="Cheat tracking pattern recognition with gen information")
...
elif reco_args.genTracking:
    sequenceLoader.load("Tracking/GenTracking")
...
if not reco_args.trackingOnly:
    ...
    if reco_args.genTracking:
        sequenceLoader.load("ParticleFlow/Pandora_truth_tracking")
    else:
